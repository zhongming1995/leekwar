...
declare namespace wx {
  ...
  export function onShow(f:any):void;
  export function offShow(f:any):void;
  export function onHide(f:any):void;
  export function offHide(f:any):void;
  export function setKeepScreenOn(f:any):void;
  export function login(obj:any):void;
  export function getUpdateManager():any;
  export function showLoading(obj:any):any;
  ...
  export function aldSendEvent(name:String,data?:any):any;
  export function cloudLogin(cb:Function):any;
  export function loadSubpackage(res:any):any;
  export function setUserCloudStorage(data:any):any;
